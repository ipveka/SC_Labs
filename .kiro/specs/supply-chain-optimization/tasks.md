...
- [ ]* 2.2 Write unit tests for data generation
...
- [ ]* 3.5 Write unit tests for Forecaster
...
- [ ]* 4.5 Write unit tests for Optimizer
...
- [ ]* 5.6 Write unit tests for Router
...
- [ ]* 6.5 Write integration test for end-to-end workflow
