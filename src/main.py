...
2. Forecast demand using LightGBM
...
Examples:
    ...
    python src/main.py --verbose --save
"""
...
def main(
    ...
    try:
        ...
        if save:
            ...
            saved_files = output_mgr.save_all(forecasts, inventory_plan, deliveries, routes)
            
            print(f"\n✅ Outputs saved to '{output_mgr.get_output_dir()}/' directory:")
